...
The project **$apiName** is a Bonita REST API extension for **Bonita {short-bonita-version}** version #if( ${sp} == 'true' )**enterprise**#else **community**#end written in `$language` language.
