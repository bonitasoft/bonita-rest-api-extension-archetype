...
image::bonita_logo_be_efficient.png[your logo here]
...
For more details on Bonita REST API extension please refer to https://documentation.bonitasoft.com/bonita/${shortBonitaVersion}/rest-api-extensions#[documentation]
