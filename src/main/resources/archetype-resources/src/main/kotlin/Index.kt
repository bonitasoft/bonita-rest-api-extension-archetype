...
#foreach($urlParameter in $params)
        ...
        val $urlParameter = request.getParameter("$urlParameter")
                ?: return buildResponse(responseBuilder, SC_BAD_REQUEST, mapOf("error" to "the parameter $urlParameter is missing"))
#end
