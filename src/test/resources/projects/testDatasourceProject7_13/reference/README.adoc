...
The project **datasource** is a Bonita REST API extension for **Bonita 7.13.0** version  **community** written in `groovy`
...
Take the built artifact `ds-rest-api-1.0.0-SNAPSHOT.zip` and upload it to your Bonita platform (see https://documentation.bonitasoft.com/bonita/7.13/rest-api-extensions#toc7)
